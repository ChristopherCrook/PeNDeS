"""
This script is called by the plugin-wrapper, PetriNetCheck.js, which passes down the
...
from PetriNetCheck import PetriNetCheck
...
plugin = PetriNetCheck(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
